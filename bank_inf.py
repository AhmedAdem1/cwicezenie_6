...
class Bank:
    def __init__(self, name, bank_accounts, bank_cards):
        self.name = name 
        self.bank_account = bank_accounts
        self.bank_cards = bank_cards

    def get_bank_accounts(self):
        print(self.get_bank_accounts)
...
class GoldenCreditCard(CreditCard):
    def __init__(self, owner, number, provider, balance, payment_history, reward_points ):
        super().__init__(owner, number, provider, balance, payment_history, reward_points)
        self.reward_point = reward_points

    def get_reward_points(self):
        print(self.reward_point)
